...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="prospect",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, copy) NSString * _Nullable accountNumber;
@property (nonatomic, copy) NSString * _Nullable telefono;
- (nonnull instancetype)initWithAccountNumber:(NSString * _Nonnull)accountNumber telefono:(NSString * _Nonnull)telefono OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
- (nonnull instancetype)initWithUser:(NSString * _Nonnull)user password:(NSString * _Nonnull)password SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithUser:(NSString * _Nonnull)user password:(NSString * _Nonnull)password ip:(NSString * _Nonnull)ip SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC8prospect27ConsultOTAccountAppResponse")
...
- (void)onErrorWithStatment:(NSString * _Nonnull)statment;
- (void)didReceiveMemoryWarning;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface PayServicePresenter : BaseEstrategiaPresenter <UITextFieldDelegate>
- (void)loadBalance;
- (BOOL)textField:(UITextField * _Nonnull)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString * _Nonnull)string SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC8prospect19TimeToArriveRequest")
@interface TimeToArriveRequest : BaseRequest
@property (nonatomic, copy) NSString * _Nullable idOperario;
@property (nonatomic, copy) NSString * _Nullable idOT;
- (nonnull instancetype)initWithIdOperario:(NSString * _Nonnull)idOperario idOT:(NSString * _Nonnull)idOT OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
- (nonnull instancetype)initWithUser:(NSString * _Nonnull)user password:(NSString * _Nonnull)password SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithUser:(NSString * _Nonnull)user password:(NSString * _Nonnull)password ip:(NSString * _Nonnull)ip SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC8prospect20TimeToArriveResponse")
@interface TimeToArriveResponse : BaseResponse
@property (nonatomic, copy) NSString * _Nonnull latOrigin;
@property (nonatomic, copy) NSString * _Nonnull longOrigin;
@property (nonatomic, copy) NSString * _Nonnull latDestination;
@property (nonatomic, copy) NSString * _Nonnull longDestination;
@property (nonatomic, copy) NSString * _Nonnull homeAddress;
@property (nonatomic, copy) NSString * _Nonnull destinationAddress;
@property (nonatomic, copy) NSString * _Nonnull date;
@property (nonatomic, copy) NSString * _Nonnull turn;
@property (nonatomic, copy) NSString * _Nonnull hour;
@property (nonatomic, copy) NSString * _Nonnull minutes;
@property (nonatomic, copy) NSString * _Nonnull seconds;
@property (nonatomic, copy) NSString * _Nonnull translateTime;
@property (nonatomic, copy) NSString * _Nonnull operatorName;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8prospect22TracingDetailPresenter")
...
SWIFT_CLASS("_TtC8prospect27TracingDetailViewController")
...
SWIFT_CLASS("_TtC8prospect19TracingMapPresenter")
...
@property (nonatomic, strong) WorkOrder * _Null_unspecified mWorkOrder;
@property (nonatomic, strong) TimeToArriveResponse * _Null_unspecified mTimeToArrivalResponse;
- (void)onRequestWs;
- (void)successLoadTimeArriveWithRequestUrl:(NSString * _Nonnull)requestUrl timeToArriveResponse:(TimeToArriveResponse * _Nonnull)timeToArriveResponse;
- (void)onSuccessLoadResponseWithRequestUrl:(NSString * _Nonnull)requestUrl response:(BaseResponse * _Nonnull)response;
- (void)viewDidLoad;
...
- (void)showPathWithPolyStr:(NSString * _Nonnull)polyStr;
- (void)didReceiveMemoryWarning;
- (void)onSuccessArrivalCoordinatesWithMTimeToArriveResponse:(TimeToArriveResponse * _Nonnull)mTimeToArriveResponse;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8prospect16TracingPresenter")
@interface TracingPresenter : BaseEstrategiaPresenter
- (void)validateAccountNumberWithAccountNumber:(NSString * _Nonnull)accountNumber mTelefono:(NSString * _Nonnull)mTelefono;
- (void)successLoadWorkOrderWithRequestUrl:(NSString * _Nonnull)requestUrl consultOtAccountAppResponse:(ConsultOTAccountAppResponse * _Nonnull)consultOtAccountAppResponse;
- (void)onSuccessLoadResponseWithRequestUrl:(NSString * _Nonnull)requestUrl response:(BaseResponse * _Nonnull)response;
- (nonnull instancetype)initWithViewController:(BaseViewController * _Nonnull)viewController OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8prospect21TracingViewController")
@interface TracingViewController : BaseViewController
@property (nonatomic, strong) TracingPresenter * _Null_unspecified mTracingPresenter;
@property (nonatomic, strong) FormValidator * _Null_unspecified mFormValidator;
@property (nonatomic, strong) CheckBoxGroup * _Null_unspecified mTraceMethodsGroup;
@property (nonatomic, copy) NSString * _Nullable mTypeSelection;
@property (nonatomic) BOOL mIsFolioSelect;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (IBAction)onNextButtonClick:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC8prospect9WorkOrder")
@interface WorkOrder : NSObject
@property (nonatomic, copy) NSString * _Nonnull idOT;
@property (nonatomic, copy) NSString * _Nonnull oTAssigned;
@property (nonatomic, copy) NSString * _Nonnull statusOT;
@property (nonatomic, copy) NSString * _Nonnull subStatusOT;
